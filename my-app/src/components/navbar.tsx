...
export default function Navbar() {
  return (
    <div className="flex min-h-screen flex-col mx-auto">
      {/* Navbar content */}
      <div className="flex-row items-center justify-center m-2 gap-5 grid grid-cols-3">
        {/* Logo section */}
        <Logo />
        ...
        <div className="flex flex-row items-center justify-center text-center gap-4">
          <ModeToggle />
          <Link href="/login">
            <ShimmerButton className="h-10 w-fit dark:text-white">Login</ShimmerButton>
          </Link>
          <Link href="/signup">
            <InteractiveHoverButton className="h-10 w-fit">Sign Up</InteractiveHoverButton>
          </Link>
        </div>
      </div>
    </div>
